 ...
 */
final class Version20190221225709 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comments ADD surfer_id INT DEFAULT NULL, ADD provider_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE comments ADD CONSTRAINT FK_5F9E962A6729D507 FOREIGN KEY (surfer_id) REFERENCES surfer (id)');
        $this->addSql('ALTER TABLE comments ADD CONSTRAINT FK_5F9E962AA53A8AA FOREIGN KEY (provider_id) REFERENCES provider (id)');
        $this->addSql('CREATE INDEX IDX_5F9E962A6729D507 ON comments (surfer_id)');
        $this->addSql('CREATE INDEX IDX_5F9E962AA53A8AA ON comments (provider_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comments DROP FOREIGN KEY FK_5F9E962AA53A8AA');
        $this->addSql('DROP INDEX IDX_5F9E962A6729D507 ON comments');
        $this->addSql('DROP INDEX IDX_5F9E962AA53A8AA ON comments');
        $this->addSql('ALTER TABLE comments DROP surfer_id, DROP provider_id');
